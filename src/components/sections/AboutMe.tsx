...
const PROFILE_IMAGE = '/images/imagenueva.png'; // nueva imagen añadida por el usuario
    ...
    <section id="about" className="about section section-full">
      <div className="container">
        <h2 className="about__section-title">
          Sobre <span className="gold-text">Mí</span>
        </h2>

        <div className="about__main">
          {/* FOTO CIRCULAR TIPO LENTE NÍTIDA Y EN COLOR */}
          <div className="about__photo-wrapper">
            <div className="about__photo-glow" />
            <img
              src={PROFILE_IMAGE}
              alt="Iván Pons - Full Stack Developer"
